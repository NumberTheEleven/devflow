...
argument-hint: [验证范围]
allowed-tools: [Read, Glob, Grep, Bash, Edit, TaskCreate, browser_navigate, browser_console_messages, browser_network_requests, browser_snapshot, browser_scroll, browser_click, browser_type, browser_wait_for, browser_fill_form, browser_select_option, browser_press_key, browser_hover, browser_take_screenshot, browser_evaluate]
---
